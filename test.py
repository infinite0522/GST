...
def parse_args():
    ...
    parser.add_argument('--data-dir', default=r'/home/home/shangmiao/datasets/Counting/qnrf-Train-Val-Test',
                        help='training data directory')
    parser.add_argument('--save-dir', default='best_model_qnrf.pth',
